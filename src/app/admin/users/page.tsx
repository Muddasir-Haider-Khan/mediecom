                            ...
                            <tr key={user.id} className="hover:bg-surface-50 transition">
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs font-semibold text-surface-900">{user.name}</p>
                                            <p className="text-[10px] text-surface-500">{user.email}</p>
                                        </div>
                                    </div>
                                </td>
                                <td className="px-6 py-4">
                                    <span className={`badge text-[10px] ${roleColors[user.role]}`}>{user.role}</span>
                                </td>
                                <td className="px-6 py-4 text-xs text-surface-600">{user.orders}</td>
                                <td className="px-6 py-4 text-xs text-surface-500">{user.joined}</td>
                                <td className="px-6 py-4">
